/*! jQuery v3.6.0 | (c) OpenJS Foundation and other contributors | jquery.org/license */ ! function(e, t) {
    ...
    var k = function(e) {
        var t, n, i, o, r, s, a, l, c, u, p, h, d, f, g, y, m, v, b, x = "sizzle" + 1 * new Date,
            w = e.document,
            _ = 0,
            k = 0,
            E = le(),
        ...
        function ae(e, t, i, o) {
            var r, a, c, u, p, f, m, v = t && t.ownerDocument,
                w = t ? t.nodeType : 9;
            ...
            if (!o && (h(t), t = t || d, g)) {
                ...
                if (n.qsa && !A[e + " "] && (!y || !y.test(e)) && (1 !== w || "object" !== t.nodeName.toLowerCase())) {
                    if (m = e, v = t, 1 === w && (Y.test(e) || X.test(e))) {
                        for ((v = ee.test(e) && me(t.parentNode) || t) === t && n.scope || ((u = t.getAttribute("id")) ? u = u.replace(ie, oe) : t.setAttribute("id", u = x)), a = (f = s(e)).length; a--;) f[a] = (u ? "#" + u : ":scope") + " " + be(f[a]);
                        m = f.join(",")
                    }
                    try {
        ...
        for (t in n = ae.support = {}, r = ae.isXML = function(e) {
                ...
                return s != d && 9 === s.nodeType && s.documentElement && (f = (d = s).documentElement, g = !r(d), w != d && (o = d.defaultView) && o.top !== o && (o.addEventListener ? o.addEventListener("unload", re, !1) : o.attachEvent && o.attachEvent("onunload", re)), n.scope = ue((function(e) {
                ...
                }, m = [], y = [], (n.qsa = J.test(d.querySelectorAll)) && (ue((function(e) {
                    var t;
                    ...
                    t.setAttribute("type", "hidden"), e.appendChild(t).setAttribute("name", "D"), e.querySelectorAll("[name=d]").length && y.push("name" + H + "*[*^$|!~]?="), 2 !== e.querySelectorAll(":enabled").length && y.push(":enabled", ":disabled"), f.appendChild(e).disabled = !0, 2 !== e.querySelectorAll(":disabled").length && y.push(":enabled", ":disabled"), e.querySelectorAll("*,:x"), y.push(",.*:")
                ...
                })), y = y.length && new RegExp(y.join("|")), m = m.length && new RegExp(m.join("|")), t = J.test(f.compareDocumentPosition), b = t || J.test(f.contains) ? function(e, t) {
                ...
                if (h(e), n.matchesSelector && g && !A[t + " "] && (!m || !m.test(t)) && (!y || !y.test(t))) try {
                    var i = v.call(e, t);
                ...
                preFilter: {
                    ...
                    PSEUDO: function(e) {
                        var t, n = !e[6] && e[2];
                        return $.CHILD.test(e[0]) ? null : (e[3] ? e[2] = e[4] || e[5] || "" : n && B.test(n) && (t = s(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && (e[0] = e[0].slice(0, t), e[2] = n.slice(0, t)), e.slice(0, 3))
                    }
                },
                filter: {
                    TAG: function(e) {
                        ...
                        return 1 === i && 0 === o ? function(e) {
                            ...
                            if (y) {
                                ...
                                if (f = [s ? y.firstChild : y.lastChild], s && v) {
                                    for (b = (d = (c = (u = (p = (h = y)[x] || (h[x] = {}))[h.uniqueID] || (p[h.uniqueID] = {}))[e] || [])[0] === _ && c[1]) && c[2], h = d && y.childNodes[d]; h = ++d && h && h[g] || (b = d = 0) || f.pop();)
                                    ...
                                    for (;
                                        (h = ++d && h && h[g] || (b = d = 0) || f.pop()) && ((a ? h.nodeName.toLowerCase() !== m : 1 !== h.nodeType) || !++b || (v && ((u = (p = h[x] || (h[x] = {}))[h.uniqueID] || (p[h.uniqueID] = {}))[e] = [_, b]), h !== t)););
        ...
        function ke(e, t, n, i, o, r) {
            return i && !i[x] && (i = ke(i)), o && !o[x] && (o = ke(o, r)), ce((function(r, s, a, l) {
                var c, u, p, h = [],
                    ...
                    m = n ? o || (r ? e : f || i) ? [] : s : y;
                if (n && n(y, m, a, l), i)
                    for (c = _e(m, d), i(c, [], a, l), u = c.length; u--;)(p = c[u]) && (m[d[u]] = !(y[d[u]] = p));
                if (r) {
                    if (o || e) {
                        if (o) {
        ...
        return ve.prototype = i.filters = i.pseudos, i.setFilters = new ve, s = ae.tokenize = function(e, t) {
            ...
            for (a = e, l = [], c = i.preFilter; a;) {
                for (s in n && !(o = U.exec(a)) || (o && (a = a.slice(o[0].length) || a), l.push(r = [])), n = !1, (o = X.exec(a)) && (n = o.shift(), r.push({
                        value: n,
                        type: o[0].replace(F, " ")
            ...
            if (!y) {
                ...
                (y = S(e, (o = f, a = 0 < (r = p).length, l = 0 < o.length, u = function(e, t, n, s, u) {
                    var p, f, y, m = 0,
                        v = "0",
                        b = e && [],
                        x = [],
        ...
        }, n.sortStable = x.split("").sort(C).join("") === x, n.detectDuplicates = !!p, h(), n.sortDetached = ue((function(e) {
    ...
    (w.fn.init = function(e, t, n) {
        ...
        if (n = n || O, "string" == typeof e) {
            ...
            if (i[1]) {
                if (t = t instanceof w ? t[0] : t, w.merge(this, w.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : y, !0)), C.test(i[1]) && w.isPlainObject(t))
                                ...
                                var a = this,
                                    ...
                                    c = function() {
                                        ...
                                        if (!(t < r)) {
                                            ...
                                            c = e && ("object" == typeof e || "function" == typeof e) && e.then, f(c) ? o ? c.call(e, s(r, n, I, o), s(r, n, H, o)) : (r++, c.call(e, s(r, n, I, o), s(r, n, H, o), s(r, n, I, n.notifyWith))) : (i !== I && (a = void 0, l = [e]), (o || n.resolveWith)(a, l))
                                        }
                                    },
                                    u = o ? c : function() {
                                        try {
    ...
    }), w.ready.then = z.then, "complete" === y.readyState || "loading" !== y.readyState && !y.documentElement.doScroll ? e.setTimeout(w.ready) : (y.addEventListener("DOMContentLoaded", W), e.addEventListener("load", W));
    ...
    function be(e, t, n, i, o) {
        ...
        for (p.textContent = "", d = 0; r = h[d++];)
            ...
            else if (c = oe(r), s = ye(p.appendChild(r), "script"), c && me(s), n)
    ...
    w.event = {
        ...
        add: function(e, t, n, i, o) {
            var r, s, a, l, c, u, p, h, d, f, g, y = K.get(e);
            if (V(e))
                for (n.handler && (n = (r = n).handler, o = r.selector), o && w.find.matchesSelector(ie, o), n.guid || (n.guid = w.guid++), (l = y.events) || (l = y.events = Object.create(null)), (s = y.handle) || (s = y.handle = function(t) {
                        return void 0 !== w && w.event.triggered !== t.type ? w.event.dispatch.apply(e, arguments) : void 0
                    }), c = (t = (t || "").match(P) || [""]).length; c--;) d = g = (a = xe.exec(t[c]) || [])[1], f = (a[2] || "").split(".").sort(), d && (p = w.event.special[d] || {}, d = (o ? p.delegateType : p.bindType) || d, p = w.event.special[d] || {}, u = w.extend({
                    type: d,
                    origType: g,
                    data: i,
                    handler: n,
                    ...
                    namespace: f.join(".")
                }, r), (h = l[d]) || ((h = l[d] = []).delegateCount = 0, p.setup && !1 !== p.setup.call(e, i, f, s) || e.addEventListener && e.addEventListener(d, s)), p.add && (p.add.call(e, u), u.handler.guid || (u.handler.guid = n.guid)), o ? h.splice(h.delegateCount++, 0, u) : h.push(u), w.event.global[d] = !0)
        },
        remove: function(e, t, n, i, o) {
            var r, s, a, l, c, u, p, h, d, f, g, y = K.hasData(e) && K.get(e);
            if (y && (l = y.events)) {
                for (c = (t = (t || "").match(P) || [""]).length; c--;)
                    if (d = g = (a = xe.exec(t[c]) || [])[1], f = (a[2] || "").split(".").sort(), d) {
                        for (p = w.event.special[d] || {}, h = l[d = (i ? p.delegateType : p.bindType) || d] || [], a = a[2] && new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = r = h.length; r--;) u = h[r], !o && g !== u.origType || n && n.guid !== u.guid || a && !a.test(u.namespace) || i && i !== u.selector && ("**" !== i || !u.selector) || (h.splice(r, 1), u.selector && h.delegateCount--, p.remove && p.remove.call(e, u));
    ...
    function Ne(e, t, n, i) {
        ...
        var o, s, a, l, c, u, p = 0,
            ...
            y = t[0],
            m = f(y);
        if (m || 1 < h && "string" == typeof y && !d.checkClone && Ae.test(y)) return e.each((function(o) {
            var r = e.eq(o);
        ...
        if (h && (s = (o = be(t, e[0].ownerDocument, !1, e, i)).firstChild, 1 === o.childNodes.length && (o = s), s || i)) {
            ...
            if (l)
                for (u = a[a.length - 1].ownerDocument, w.map(a, Me), p = 0; p < l; p++) c = a[p], fe.test(c.type || "") && !K.access(c, "globalEval") && w.contains(u, c) && (c.src && "module" !== (c.type || "").toLowerCase() ? w._evalUrl && !c.noModule && w._evalUrl(c.src, {
                    nonce: c.nonce || c.getAttribute("nonce")
                }, u) : v(c.textContent.replace(Ce, ""), c, u))
        }
        return e
    }
    ...
    w.extend({
        ...
        clone: function(e, t, n) {
            ...
            if (!(d.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || w.isXMLDoc(e)))
                for (s = ye(u), i = 0, o = (r = ye(e)).length; i < o; i++) a = r[i], "input" === (c = (l = s[i]).nodeName.toLowerCase()) && he.test(a.type) ? l.checked = a.checked : "input" !== c && "textarea" !== c || (l.defaultValue = a.defaultValue);
            if (t)
                if (n)
                    for (r = r || ye(e), s = s || ye(u), i = 0, o = r.length; i < o; i++) je(r[i], s[i]);
                else je(e, u);
    ...
    function qe(e, t, n) {
        ...
        return (n = n || Ie(e)) && ("" !== (s = n.getPropertyValue(t) || n[t]) || oe(e) || (s = w.style(e, t)), !d.pixelBoxStyles() && Pe.test(s) && Re.test(t) && (i = a.width, o = a.minWidth, r = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = i, a.minWidth = o, a.maxWidth = r)), void 0 !== s ? s + "" : s
    }
    ...
    function Xe(e) {
        return w.cssProps[e] || Ue[e] || (e in Fe ? e : Ue[e] = function(e) {
    ...
    function Ge(e, t, n) {
        ...
        return (!d.boxSizingReliable() && o || !d.reliableTrDimensions() && A(e, "tr") || "auto" === s || !parseFloat(s) && "inline" === w.css(e, "display", !1, i)) && e.getClientRects().length && (o = "border-box" === w.css(e, "boxSizing", !1, i), (r = a in e) && (s = e[a])), (s = parseFloat(s) || 0) + Qe(e, t, n || (o ? "border" : "content"), r, i, s) + "px"
    }
    ...
    w.extend({
        ...
        style: function(e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                ...
                "string" == (r = typeof n) && (o = te.exec(n)) && o[1] && (n = ae(e, t, o), r = "number"), null != n && n == n && ("number" !== r || l || (n += o && o[3] || (w.cssNumber[a] ? "" : "px")), d.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (c[t] = "inherit"), s && "set" in s && void 0 === (n = s.set(e, n, i)) || (l ? c.setProperty(t, n) : c[t] = n))
            }
        },
        css: function(e, t, n, i) {
            var o, r, s, a = B(t);
            return Be.test(t) || (t = Xe(a)), (s = w.cssHooks[t] || w.cssHooks[a]) && "get" in s && (o = s.get(e, !0, n)), void 0 === o && (o = qe(e, t, i)), "normal" === o && t in $e && (o = $e[t]), "" === n || n ? (r = parseFloat(o), !0 === n || isFinite(r) ? r || 0 : o) : o
        }
    }), w.each(["height", "width"], (function(e, t) {
        w.cssHooks[t] = {
            get: function(e, n, i) {
                if (n) return !Ye.test(w.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? Ge(e, t, i) : He(e, Ve, (function() {
                    return Ge(e, t, i)
                }))
            },
            set: function(e, n, i) {
    ...
    function ct(e, t, n) {
        ...
        return w.map(u, lt, c), f(c.opts.start) && c.opts.start.call(e, c), c.progress(c.opts.progress).done(c.opts.done, c.opts.complete).fail(c.opts.fail).always(c.opts.always), w.fx.timer(w.extend(l, {
            elem: e,
            anim: c,
            queue: c.opts.queue
        })), c
    ...
    w.Animation = w.extend(ct, {
        ...
        prefilters: [function(e, t, n) {
            ...
            if ((l = !w.isEmptyObject(t)) || !w.isEmptyObject(d))
                for (i in p && 1 === e.nodeType && (n.overflow = [f.overflow, f.overflowX, f.overflowY], null == (c = y && y.display) && (c = K.get(e, "display")), "none" === (u = w.css(e, "display")) && (c ? u = c : (ce([e], !0), c = e.style.display || c, u = w.css(e, "display"), ce([e]))), ("inline" === u || "inline-block" === u && null != c) && "none" === w.css(e, "float") && (l || (h.done((function() {
                        f.display = c
                    })), null == c && (u = f.display, c = "none" === u ? "" : u)), f.display = "inline-block")), n.overflow && (f.overflow = "hidden", h.always((function() {
                        f.overflow = n.overflow[0], f.overflowX = n.overflow[1], f.overflowY = n.overflow[2]
                    }))), l = !1, d) l || (y ? "hidden" in y && (g = y.hidden) : y = K.access(e, "fxshow", {
                    display: c
                }), r && (y.hidden = !g), g && ce([e], !0), h.done((function() {
                    for (i in g || ce([e]), K.remove(e, "fxshow"), d) w.style(e, i, d[i])
                }))), l = lt(g ? y[i] : 0, i, h), i in y || (y[i] = l.start, g && (l.end = l.start, l.start = 0))
        }],
    ...
    }, tt = y.createElement("input"), nt = y.createElement("select").appendChild(y.createElement("option")), tt.type = "checkbox", d.checkOn = "" !== tt.value, d.optSelected = nt.selected, (tt = y.createElement("input")).value = "t", tt.type = "radio", d.radioValue = "t" === tt.value;
    ...
    w.fn.extend({
        ...
        toggleClass: function(e, t) {
            ...
            return "boolean" == typeof t && i ? t ? this.addClass(e) : this.removeClass(e) : f(e) ? this.each((function(n) {
                ...
                var t, o, r, s;
                if (i)
                    for (o = 0, r = w(this), s = yt(e); t = s[o++];) r.hasClass(t) ? r.removeClass(t) : r.addClass(t);
        ...
        hasClass: function(e) {
            var t, n, i = 0;
            for (t = " " + e + " "; n = this[i++];)
                if (1 === n.nodeType && -1 < (" " + ft(gt(n)) + " ").indexOf(t)) return !0;
            return !1
        }
    });
    var mt = /\r/g;
    ...
    w.extend(w.event, {
        trigger: function(t, n, i, o) {
            var r, s, a, l, c, p, h, d, m = [i || y],
                v = u.call(t, "type") ? t.type : t,
                b = u.call(t, "namespace") ? t.namespace.split(".") : [];
            if (s = d = a = i = i || y, 3 !== i.nodeType && 8 !== i.nodeType && !vt.test(v + w.event.triggered) && (-1 < v.indexOf(".") && (v = (b = v.split(".")).shift(), b.sort()), c = v.indexOf(":") < 0 && "on" + v, (t = t[w.expando] ? t : new w.Event(v, "object" == typeof t && t)).isTrigger = o ? 2 : 3, t.namespace = b.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + b.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = i), n = null == n ? [t] : w.makeArray(n, [t]), h = w.event.special[v] || {}, o || !h.trigger || !1 !== h.trigger.apply(i, n))) {
                if (!o && !h.noBubble && !g(i)) {
                ...
                for (r = 0;
                    (s = m[r++]) && !t.isPropagationStopped();) d = s, t.type = 1 < r ? l : h.bindType || v, (p = (K.get(s, "events") || Object.create(null))[t.type] && K.get(s, "handle")) && p.apply(s, n), (p = c && s[c]) && p.apply && V(s) && (t.result = p.apply(s, n), !1 === t.result && t.preventDefault());
                return t.type = v, o || t.isDefaultPrevented() || h._default && !1 !== h._default.apply(m.pop(), n) || !V(i) || c && f(i[v]) && !g(i) && ((a = i[c]) && (i[c] = null), w.event.triggered = v, t.isPropagationStopped() && d.addEventListener(v, bt), i[v](), t.isPropagationStopped() && d.removeEventListener(v, bt), w.event.triggered = void 0, a && (i[c] = a)), t.result
            }
        },
    ...
    Ht.href = xt.href, w.extend({
        ...
        ajax: function(t, n) {
            ...
            var i, o, r, s, a, l, c, u, p, h, d = w.ajaxSetup({}, n),
                f = d.context || d,
            ...
            if (m.promise(E), d.url = ((t || d.url || xt.href) + "").replace(Nt, xt.protocol + "//"), d.type = n.method || n.type || d.method || d.type, d.dataTypes = (d.dataType || "*").toLowerCase().match(P) || [""], null == d.crossDomain) {
                l = y.createElement("a");
                try {
            ...
            function T(t, n, s, l) {
                ...
                }(d, E, s)), !p && -1 < w.inArray("script", d.dataTypes) && w.inArray("json", d.dataTypes) < 0 && (d.converters["text script"] = function() {}), x = function(e, t, n, i) {
                    var o, r, s, a, l, c = {},
                        u = e.dataTypes.slice();
                    if (u[1])
                ...
                }(d, x, E, p), p ? (d.ifModified && ((_ = E.getResponseHeader("Last-Modified")) && (w.lastModified[o] = _), (_ = E.getResponseHeader("etag")) && (w.etag[o] = _)), 204 === t || "HEAD" === d.type ? k = "nocontent" : 304 === t ? k = "notmodified" : (k = x.state, h = x.data, p = !(y = x.error))) : (y = k, !t && k || (k = "error", t < 0 && (t = 0))), E.status = t, E.statusText = (n || k) + "", p ? m.resolveWith(f, [h, k, E]) : m.rejectWith(f, [E, k, y]), E.statusCode(b), b = void 0, u && g.trigger(p ? "ajaxSuccess" : "ajaxError", [E, d, p ? h : y]), v.fireWith(f, [E, k]), u && (g.trigger("ajaxComplete", [E, d]), --w.active || w.event.trigger("ajaxStop")))
            }
            return E
        },
    ...
    d.cors = !!Ft && "withCredentials" in Ft, d.ajax = Ft = !!Ft, w.ajaxTransport((function(t) {
        var n, i;
    ...
    w.ajaxSetup({
        ...
        if (a || "jsonp" === t.dataTypes[0]) return o = t.jsonpCallback = f(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, a ? t[a] = t[a].replace(Yt, "$1" + o) : !1 !== t.jsonp && (t.url += (_t.test(t.url) ? "&" : "?") + t.jsonp + "=" + o), t.converters["script json"] = function() {
    ...
    })), d.createHTMLDocument = ((Ut = y.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>", 2 === Ut.childNodes.length), w.parseHTML = function(e, t, n) {
        return "string" != typeof e ? [] : ("boolean" == typeof t && (n = t, t = !1), t || (d.createHTMLDocument ? ((i = (t = y.implementation.createHTMLDocument("")).createElement("base")).href = y.location.href, t.head.appendChild(i)) : t = y), r = !n && [], (o = C.exec(e)) ? [t.createElement(o[1])] : (o = be([e], t, r), r && r.length && w(r).remove(), w.merge([], o.childNodes)));
        var i, o, r
    }, w.fn.load = function(e, t, n) {
        var i, o, r, s = this,
            a = e.indexOf(" ");
        return -1 < a && (i = ft(e.slice(a)), e = e.slice(0, a)), f(t) ? (n = t, t = void 0) : t && "object" == typeof t && (o = "POST"), 0 < s.length && w.ajax({
            url: e,
            type: o || "GET",
            dataType: "html",
            data: t
        ...
        setOffset: function(e, t, n) {
            var i, o, r, s, a, l, c = w.css(e, "position"),
                u = w(e),
                p = {};
            "static" === c && (e.style.position = "relative"), a = u.offset(), r = w.css(e, "top"), l = w.css(e, "left"), ("absolute" === c || "fixed" === c) && -1 < (r + l).indexOf("auto") ? (s = (i = u.position()).top, o = i.left) : (s = parseFloat(r) || 0, o = parseFloat(l) || 0), f(t) && (t = t.call(e, n, w.extend({}, a))), null != t.top && (p.top = t.top - a.top + s), null != t.left && (p.left = t.left - a.left + o), "using" in t ? t.using.call(e, p) : u.css(p)
        }
    }, w.fn.extend({
        offset: function(e) {
    ...
    }, w.isArray = Array.isArray, w.parseJSON = JSON.parse, w.nodeName = A, w.isFunction = f, w.isWindow = g, w.camelCase = B, w.type = b, w.now = Date.now, w.isNumeric = function(e) {
        var t = w.type(e);
...
function(e, t) {
    ...
    function h(e, o, s) {
        ...
        return (h || !h && !s) && (("body" !== a(o) || p(u)) && (d = o !== n(o) && r(o) ? {
            scrollLeft: o.scrollLeft,
            scrollTop: o.scrollTop
        } : i(o)), r(o) ? ((f = t(o)).x += o.clientLeft, f.y += o.clientTop) : u && (f.x = c(u))), {
            x: e.left + d.scrollLeft - f.x,
            y: e.top + d.scrollTop - f.y,
            width: e.width,
            height: e.height
        }
    }
    ...
    function O(e, n) {
        ...
        c = e.rects.popper, s = T(o(u = e.elements[u ? "popper" === r ? "reference" : "popper" : r]) ? u : u.contextElement || l(e.elements.popper), s, a), u = A({
            reference: a = t(p),
            element: c,
            strategy: "absolute",
            placement: n
    ...
    function N(e) {
        ...
        if (p) {
            var b = v(i),
                x = "clientHeight",
                w = "clientWidth";
            b === n(i) && "static" !== u(b = l(i)).position && (x = "scrollHeight", w = "scrollWidth"), "top" === r && (y = "bottom", h -= b[x] - o.height, h *= c ? 1 : -1), "left" === r && (g = "right", e -= b[w] - o.width, e *= c ? 1 : -1)
        }
        return i = Object.assign({
            position: a
        }, p && K), c ? Object.assign({}, i, ((f = {})[y] = s ? "0" : "", f[g] = d ? "0" : "", f.transform = 2 > (m.devicePixelRatio || 1) ? "translate(" + e + "px, " + h + "px)" : "translate3d(" + e + "px, " + h + "px, 0)", f)) : Object.assign({}, i, ((t = {})[y] = s ? h + "px" : "", t[g] = d ? e + "px" : "", t.transform = "", t))
    }
                ...
                if (a = {
                    ...
                    if (o || r) {
                        var y = "y" === p ? "top" : "left",
                            ...
                            E = i ? -f[b] / 2 : 0,
                            T = "start" === c ? h[b] : f[b];
                        c = "start" === c ? -f[b] : -h[b], f = t.elements.arrow, f = i && f ? d(f) : {
                            width: 0,
                            height: 0
                        };
                        var A = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : {
                            top: 0,
                            right: 0,
                            bottom: 0,
                            left: 0
                        };
                        y = A[y], m = A[m], f = F(0, U(h[b], f[b])), T = u ? h[b] / 2 - E - f - y - g : T - f - y - g, h = u ? -h[b] / 2 + E + f + m + g : c + f + m + g, u = t.elements.arrow && v(t.elements.arrow), g = t.modifiersData.offset ? t.modifiersData.offset[t.placement][p] : 0, u = s[p] + T - g - (u ? "y" === p ? u.clientTop || 0 : u.clientLeft || 0 : 0), h = s[p] + h - g, o && (o = i ? U(_, u) : _, k = i ? F(k, h) : k, o = F(o, U(x, k)), s[p] = o, a[p] = o - x), r && (o = (r = s[n]) + l["x" === p ? "top" : "left"], l = r - l["x" === p ? "bottom" : "right"], o = i ? U(o, u) : o, i = i ? F(l, h) : l, i = F(o, U(r, i)), s[n] = i, a[n] = i - r)
                    }
                    t.modifiersData[e] = a
                }
            },
        ...
        ie = {
            ...
            fn: function(e) {
                ...
                if (e = S(a), a = 0 <= ["left", "right"].indexOf(a) ? "height" : "width", r && s) {
                    o = C("number" != typeof(o = "function" == typeof(o = o.padding) ? o(Object.assign({}, n.rects, {
                    ...
                    s = s[e] - n.rects.reference[e], s = (r = (r = v(r)) ? "y" === e ? r.clientHeight || 0 : r.clientWidth || 0 : 0) / 2 - l[a] / 2 + (p / 2 - s / 2), a = F(o[c], U(s, r - l[a] - o[u])), n.modifiersData[i] = ((t = {})[e] = a, t.centerOffset = a - s, t)
                }
            },
            effect: function(e) {
                var t = e.state;
    ...
    e.applyStyles = G, e.arrow = ie, e.computeStyles = Q, e.createPopper = ae, e.createPopperLite = re, e.defaultModifiers = se, e.detectOverflow = O, e.eventListeners = V, e.flip = te, e.hide = oe, e.offset = J, e.popperGenerator = j, e.popperOffsets = $, e.preventOverflow = ne, Object.defineProperty(e, "__esModule", {
        value: !0
    })
})),
function(e, t) {
    ...
    const n = {
        ...
        h = (e, t, n) => {
            Object.keys(n).forEach((i => {
                const o = n[i],
                    r = t[i],
                    s = r && c(r) ? "element" : null == (a = r) ? "" + a : {}.toString.call(a).match(/\s([a-z]+)/i)[1].toLowerCase();
                var a;
    ...
    function I(e, t, n, i, o) {
        ...
        const [r, s, a] = P(t, n, i), l = N(e), c = l[a] || (l[a] = {}), u = D(c, s, r ? n : null);
                ...
                return function i(o) {
                    ...
                    for (let {
                        ...
                        for (let a = r.length; a--;)
                            if (r[a] === s) return o.delegateTarget = s, i.oneOff && q.off(e, o.type, t, n), n.apply(s, [o]);
                    return null
                }
            }(e, n, i) : function(e, t) {
                return function n(i) {
    ...
    const q = {
        ...
        off(e, t, n, i) {
            if ("string" != typeof t || !e) return;
            const [o, r, s] = P(t, n, i), a = s !== t, l = N(e), c = t.startsWith(".");
            if (void 0 !== r) {
                if (!l || !l[s]) return;
    ...
    class z {
        ...
        dispose() {
            k.remove(this._element, this.constructor.DATA_KEY), q.off(this._element, this.constructor.EVENT_KEY), Object.getOwnPropertyNames(this).forEach((e => {
                this[e] = null
            }))
        }
    ...
    class J extends z {
        ...
        _addTouchEventListeners() {
            ...
            })), this._pointerEvent ? (q.on(this._element, "pointerdown.bs.carousel", (t => e(t))), q.on(this._element, "pointerup.bs.carousel", (e => i(e))), this._element.classList.add("pointer-event")) : (q.on(this._element, "touchstart.bs.carousel", (t => e(t))), q.on(this._element, "touchmove.bs.carousel", (e => t(e))), q.on(this._element, "touchend.bs.carousel", (e => i(e))))
        }
        _keydown(e) {
    ...
    q.on(document, "click.bs.carousel.data-api", "[data-bs-slide], [data-bs-slide-to]", J.dataApiClickHandler), q.on(window, "load.bs.carousel.data-api", (() => {
    ...
    class te extends z {
        ...
        _getConfig(e) {
            return (e = { ...Z,
                ...e
            }).toggle = Boolean(e.toggle), h("collapse", e, ee), e
        }
        _getDimension() {
    ...
    class pe extends z {
        ...
        show() {
            ...
            if (!q.trigger(this._element, "show.bs.dropdown", n).defaultPrevented) {
                ...
                "ontouchstart" in document.documentElement && !e.closest(".navbar-nav") && [].concat(...document.body.children).forEach((e => q.on(e, "mouseover", y))), this._element.focus(), this._element.setAttribute("aria-expanded", !0), this._menu.classList.toggle("show"), this._element.classList.toggle("show"), q.trigger(this._element, "shown.bs.dropdown", n)
            }
        }
        hide() {
            if (f(this._element) || !this._menu.classList.contains("show")) return;
        ...
        _completeHide(e) {
            q.trigger(this._element, "hide.bs.dropdown", e).defaultPrevented || ("ontouchstart" in document.documentElement && [].concat(...document.body.children).forEach((e => q.off(e, "mouseover", y))), this._popper && this._popper.destroy(), this._menu.classList.remove("show"), this._element.classList.remove("show"), this._element.setAttribute("aria-expanded", "false"), Y.removeDataAttribute(this._menu, "popper"), q.trigger(this._element, "hidden.bs.dropdown", e))
        }
        _getConfig(e) {
            if (e = { ...this.constructor.Default,
                    ...Y.getDataAttributes(this._element),
                    ...e
                }, h("dropdown", e, this.constructor.DefaultType), "object" == typeof e.reference && !c(e.reference) && "function" != typeof e.reference.getBoundingClientRect) throw new TypeError("dropdown".toUpperCase() + ': Option "reference" provided type "object" without a required "getBoundingClientRect" method.');
            return e
        }
        _getMenuElement() {
    ...
    q.on(document, "keydown.bs.dropdown.data-api", '[data-bs-toggle="dropdown"]', pe.dataApiKeydownHandler), q.on(document, "keydown.bs.dropdown.data-api", ".dropdown-menu", pe.dataApiKeydownHandler), q.on(document, "click.bs.dropdown.data-api", pe.clearMenus), q.on(document, "keyup.bs.dropdown.data-api", pe.clearMenus), q.on(document, "click.bs.dropdown.data-api", '[data-bs-toggle="dropdown"]', (function(e) {
    ...
    class xe {
        ...
        _getConfig(e) {
            return (e = { ...ve,
                ..."object" == typeof e ? e : {}
            }).rootElement = e.rootElement || document.body, h("backdrop", e, be), e
        }
        _append() {
            this._isAppended || (this._config.rootElement.appendChild(this._getElement()), q.on(this._getElement(), "mousedown.bs.backdrop", (() => {
    ...
    class ke extends z {
        constructor(e, t) {
            super(e), this._config = this._getConfig(t), this._dialog = n.findOne(".modal-dialog", this._element), this._backdrop = this._initializeBackDrop(), this._isShown = !1, this._ignoreBackdropClick = !1, this._isTransitioning = !1
        }
        static get Default() {
            return we
        }
        ...
        show(e) {
            ...
            const t = q.trigger(this._element, "show.bs.modal", {
                relatedTarget: e
            });
            this._isShown || t.defaultPrevented || (this._isShown = !0, de(), document.body.classList.add("modal-open"), this._adjustDialog(), this._setEscapeEvent(), this._setResizeEvent(), q.on(this._element, "click.dismiss.bs.modal", '[data-bs-dismiss="modal"]', (e => this.hide(e))), q.on(this._dialog, "mousedown.dismiss.bs.modal", (() => {
        ...
        hide(e) {
            ...
            t && (this._isTransitioning = !0), this._setEscapeEvent(), this._setResizeEvent(), q.off(document, "focusin.bs.modal"), this._element.classList.remove("show"), q.off(this._element, "click.dismiss.bs.modal"), q.off(this._dialog, "mousedown.dismiss.bs.modal"), this._queueCallback((() => this._hideModal()), this._element, t)
        }
        dispose() {
        ...
        _showElement(e) {
            ...
            this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE || document.body.appendChild(this._element), this._element.style.display = "block", this._element.removeAttribute("aria-hidden"), this._element.setAttribute("aria-modal", !0), this._element.setAttribute("role", "dialog"), this._element.scrollTop = 0, i && (i.scrollTop = 0), t && m(this._element), this._element.classList.add("show"), this._config.focus && this._enforceFocus(), this._queueCallback((() => {
                this._config.focus && this._element.focus(), this._isTransitioning = !1, q.trigger(this._element, "shown.bs.modal", {
                    relatedTarget: e
                })
            }), this._dialog, t)
        }
        _enforceFocus() {
            q.off(document, "focusin.bs.modal"), q.on(document, "focusin.bs.modal", (e => {
                document === e.target || this._element === e.target || this._element.contains(e.target) || this._element.focus()
            }))
        }
        _setEscapeEvent() {
            this._isShown ? q.on(this._element, "keydown.dismiss.bs.modal", (e => {
        ...
        _triggerBackdropTransition() {
            ...
            q.off(this._element, "transitionend"), q.one(this._element, "transitionend", (() => {
                this._element.classList.remove("modal-static"), e || (q.one(this._element, "transitionend", (() => {
                    this._element.style.overflowY = ""
                })), p(this._element, t))
            })), p(this._element, t), this._element.focus()
        }
        _adjustDialog() {
            const e = this._element.scrollHeight > document.documentElement.clientHeight,
                t = he(),
    ...
    q.on(document, "click.bs.modal.data-api", '[data-bs-toggle="modal"]', (function(e) {
        const t = s(this);
        ["A", "AREA"].includes(this.tagName) && e.preventDefault(), q.one(t, "show.bs.modal", (e => {
            e.defaultPrevented || q.one(t, "hidden.bs.modal", (() => {
                d(this) && this.focus()
            }))
    ...
    class Se extends z {
        ...
        show(e) {
            this._isShown || q.trigger(this._element, "show.bs.offcanvas", {
                relatedTarget: e
            }).defaultPrevented || (this._isShown = !0, this._element.style.visibility = "visible", this._backdrop.show(), this._config.scroll || (de(), this._enforceFocusOnElement(this._element)), this._element.removeAttribute("aria-hidden"), this._element.setAttribute("aria-modal", !0), this._element.setAttribute("role", "dialog"), this._element.classList.add("show"), this._queueCallback((() => {
                q.trigger(this._element, "shown.bs.offcanvas", {
                    relatedTarget: e
                })
            }), this._element, !0))
        }
        hide() {
            this._isShown && (q.trigger(this._element, "hide.bs.offcanvas").defaultPrevented || (q.off(document, "focusin.bs.offcanvas"), this._element.blur(), this._isShown = !1, this._element.classList.remove("show"), this._backdrop.hide(), this._queueCallback((() => {
                this._element.setAttribute("aria-hidden", !0), this._element.removeAttribute("aria-modal"), this._element.removeAttribute("role"), this._element.style.visibility = "hidden", this._config.scroll || ye(), q.trigger(this._element, "hidden.bs.offcanvas")
            }), this._element, !0)))
        }
        dispose() {
        ...
        _enforceFocusOnElement(e) {
            q.off(document, "focusin.bs.offcanvas"), q.on(document, "focusin.bs.offcanvas", (t => {
                document === t.target || e === t.target || e.contains(t.target) || e.focus()
            })), e.focus()
        }
        _addEventListeners() {
            q.on(this._element, "click.dismiss.bs.offcanvas", '[data-bs-dismiss="offcanvas"]', (() => this.hide())), q.on(this._element, "keydown.dismiss.bs.offcanvas", (e => {
    ...
    class Re extends z {
        ...
        dispose() {
            clearTimeout(this._timeout), q.off(this._element.closest(".modal"), "hide.bs.modal", this._hideModalHandler), this.tip && this.tip.parentNode && this.tip.parentNode.removeChild(this.tip), this._popper && this._popper.destroy(), super.dispose()
        }
        show() {
            ...
            k.set(r, this.constructor.DATA_KEY, this), this._element.ownerDocument.documentElement.contains(this.tip) || (c.appendChild(r), q.trigger(this._element, this.constructor.Event.INSERTED)), this._popper ? this._popper.update() : this._popper = t.createPopper(this._element, r, this._getPopperConfig(l)), r.classList.add("show");
            const u = "function" == typeof this._config.customClass ? this._config.customClass() : this._config.customClass;
            u && r.classList.add(...u.split(" ")), "ontouchstart" in document.documentElement && [].concat(...document.body.children).forEach((e => {
                q.on(e, "mouseover", y)
            }));
        ...
        hide() {
            ...
            e.classList.remove("show"), "ontouchstart" in document.documentElement && [].concat(...document.body.children).forEach((e => q.off(e, "mouseover", y))), this._activeTrigger.click = !1, this._activeTrigger.focus = !1, this._activeTrigger.hover = !1;
            const t = this.tip.classList.contains("fade");
            this._queueCallback((() => {
                this._isWithActiveTrigger() || ("show" !== this._hoverState && e.parentNode && e.parentNode.removeChild(e), this._cleanTipClass(), this._element.removeAttribute("aria-describedby"), q.trigger(this._element, this.constructor.Event.HIDDEN), this._popper && (this._popper.destroy(), this._popper = null))
        ...
        setElementContent(e, t) {
            if (null !== e) return c(t) ? (t = u(t), void(this._config.html ? t.parentNode !== e && (e.innerHTML = "", e.appendChild(t)) : e.textContent = t.textContent)) : void(this._config.html ? (this._config.sanitize && (t = Me(t, this._config.allowList, this._config.sanitizeFn)), e.innerHTML = t) : e.textContent = t)
        }
        getTitle() {
        ...
        _setListeners() {
            ...
            }, q.on(this._element.closest(".modal"), "hide.bs.modal", this._hideModalHandler), this._config.selector ? this._config = { ...this._config,
                trigger: "manual",
                selector: ""
            } : this._fixTitle()
        }
        ...
        _getConfig(e) {
            ...
            return Object.keys(t).forEach((e => {
                ...
                ...t,
                ..."object" == typeof e && e ? e : {}
            }).container = !1 === e.container ? document.body : u(e.container), "number" == typeof e.delay && (e.delay = {
                show: e.delay,
                hide: e.delay
            }), "number" == typeof e.title && (e.title = e.title.toString()), "number" == typeof e.content && (e.content = e.content.toString()), h("tooltip", e, this.constructor.DefaultType), e.sanitize && (e.template = Me(e.template, e.allowList, e.sanitizeFn)), e
        }
        _getDelegateConfig() {
            const e = {};
            if (this._config)
    ...
    class Ve extends z {
        ...
        show() {
            ...
            const o = e ? q.trigger(e, "hide.bs.tab", {
                relatedTarget: this._element
            }) : null;
            ...
            const r = () => {
                q.trigger(e, "hidden.bs.tab", {
                    relatedTarget: this._element
                }), q.trigger(this._element, "shown.bs.tab", {
                    relatedTarget: e
                })
            };
    ...
    class Qe extends z {
        ...
        show() {
            q.trigger(this._element, "show.bs.toast").defaultPrevented || (this._clearTimeout(), this._config.animation && this._element.classList.add("fade"), this._element.classList.remove("hide"), m(this._element), this._element.classList.add("showing"), this._queueCallback((() => {
        ...
        hide() {
            this._element.classList.contains("show") && (q.trigger(this._element, "hide.bs.toast").defaultPrevented || (this._element.classList.remove("show"), this._queueCallback((() => {
        ...
        _getConfig(e) {
            return e = { ...Ke,
                ...Y.getDataAttributes(this._element),
                ..."object" == typeof e && e ? e : {}
            }, h("toast", e, this.constructor.DefaultType), e
        }
        _maybeScheduleHide() {
        ...
        _setListeners() {
            q.on(this._element, "click.dismiss.bs.toast", '[data-bs-dismiss="toast"]', (() => this.hide())), q.on(this._element, "mouseover.bs.toast", (e => this._onInteraction(e, !0))), q.on(this._element, "mouseout.bs.toast", (e => this._onInteraction(e, !1))), q.on(this._element, "focusin.bs.toast", (e => this._onInteraction(e, !0))), q.on(this._element, "focusout.bs.toast", (e => this._onInteraction(e, !1)))
        }
        _clearTimeout() {
...
function(e, t) {
    ...
    function h(e, t, n, i, o) {
        ...
        if (void 0 === i && (i = !0), void 0 === o && (o = !1), "top" === t) r = ["contentHeight", "containerHeight", "scrollTop", "y", "up", "down"];
            ...
            var d = e.element;
            e.reach[l] = null, 1 > d[a] && (e.reach[l] = "start"), d[a] > e[r] - e[s] - 1 && (e.reach[l] = "end"), t && (d.dispatchEvent(p("ps-scroll-" + l)), 0 > t ? d.dispatchEvent(p("ps-scroll-" + c)) : 0 < t && d.dispatchEvent(p("ps-scroll-" + h)), i && u(e, l)), e.reach[l] && (t || o) && d.dispatchEvent(p("ps-" + l + "-reach-" + e.reach[l]))
        }(e, n, r, i, o)
    }
    ...
    function v(e, t) {
        ...
        function o(t, o) {
            v = m[d], o && t.touches && (t[a] = t.touches[0].pageY), b = t[a], w = (e[s] - e[r]) / (e[u] - e[h]), o ? e.event.bind(e.ownerDocument, "touchmove", n) : (e.event.bind(e.ownerDocument, "mousemove", n), e.event.once(e.ownerDocument, "mouseup", i), t.preventDefault()), e[y].classList.add(x.state.clicking), t.stopPropagation()
        }
        var r = t[0],
            s = t[1],
            a = t[2],
    ...
    var T = {
        ...
        A = function(e, r) {
            ...
            this.scrollbarXBottom = parseInt(u.bottom, 10), isNaN(this.scrollbarXBottom) ? (this.isScrollbarXUsingBottom = !1, this.scrollbarXTop = d(u.top)) : this.isScrollbarXUsingBottom = !0, this.railBorderXWidth = d(u.borderLeftWidth) + d(u.borderRightWidth), i(this.scrollbarXRail, {
                display: "block"
            }), this.railXMarginWidth = d(u.marginLeft) + d(u.marginRight), i(this.scrollbarXRail, {
                display: ""
            ...
            this.scrollbarYRight = parseInt(p.right, 10), isNaN(this.scrollbarYRight) ? (this.isScrollbarYUsingRight = !1, this.scrollbarYLeft = d(p.left)) : this.isScrollbarYUsingRight = !0, this.scrollbarYOuterWidth = this.isRtl ? function(e) {
                var t = n(e);
                return d(t.width) + d(t.paddingLeft) + d(t.paddingRight) + d(t.borderLeftWidth) + d(t.borderRightWidth)
            }(this.scrollbarY) : null, this.railBorderYWidth = d(p.borderTopWidth) + d(p.borderBottomWidth), i(this.scrollbarYRail, {
                display: "block"
            }), this.railYMarginHeight = d(p.marginTop) + d(p.marginBottom), i(this.scrollbarYRail, {
                display: ""
    ...
    return A.prototype.update = function() {
        this.isAlive && (this.negativeScrollAdjustment = this.isNegativeScroll ? this.element.scrollWidth - this.element.clientWidth : 0, i(this.scrollbarXRail, {
            ...
            display: "block"
        }), this.railXMarginWidth = d(n(this.scrollbarXRail).marginLeft) + d(n(this.scrollbarXRail).marginRight), this.railYMarginHeight = d(n(this.scrollbarYRail).marginTop) + d(n(this.scrollbarYRail).marginBottom), i(this.scrollbarXRail, {
            display: "none"
        }), i(this.scrollbarYRail, {
            display: "none"
...
function(e, t, n, i) {
        ...
        n.isFirst = !!r, n.isFinal = !!s, r && (e.session = {}), n.eventType = t,
            function(e, t) {
                ...
                var r = n.firstInput,
                    ...
                    l = t.center = S(i);
                t.timeStamp = ce(), t.deltaTime = t.timeStamp - r.timeStamp, t.angle = O(a, l), t.distance = L(a, l),
                    function(e, t) {
                        var n = t.center,
                            i = e.offsetDelta || {},
                            o = e.prevDelta || {},
                    ...
                    }(n, t), t.offsetDirection = C(t.deltaX, t.deltaY);
    ...
    function ee(e, t) {
        ...
        }(this), this.touchAction = new W(this, this.options.touchAction), te(this, !0), s(this.options.recognizers, (function(e) {
    ...
    F.prototype = {
        ...
        directionTest: function(e) {
            var t = this.options,
                ...
                r = e.deltaX,
                s = e.deltaY;
            return o & t.direction || (t.direction & Ce ? (o = 0 === r ? ke : 0 > r ? Ee : Te, n = r != this.pX, i = Math.abs(e.deltaX)) : (o = 0 === s ? ke : 0 > s ? Se : Ae, n = s != this.pY, i = Math.abs(e.deltaY))), e.direction = o, n && i > t.threshold && o & t.direction
        },
        attrTest: function(e) {
        ...
        attrTest: function(e) {
            ...
            return n & (Ce | Le) ? t = e.overallVelocity : n & Ce ? t = e.overallVelocityX : n & Le && (t = e.overallVelocityY), this._super.attrTest.call(this, e) && n & e.offsetDirection && e.distance > this.options.threshold && e.maxPointers == this.options.pointers && le(t) > this.options.velocity && e.eventType & we
        },
        emit: function(e) {
        ...
        function e(e) {
            function t(t, i) {
                ...
                if (!(i = e.extend({}, e.blockUI.defaults, i || {})).ignoreIfBlocked || !e(t).data("blockUI.isBlocked")) {
                    if (i.overlayCSS = e.extend({}, e.blockUI.defaults.overlayCSS, i.overlayCSS || {}), r = e.extend({}, e.blockUI.defaults.css, i.css || {}), i.onOverlayClick && (i.overlayCSS.cursor = "pointer"), f = e.extend({}, e.blockUI.defaults.themedCSS, i.themedCSS || {}), y = void 0 === y ? i.message : y, g && h && n(window, {
                            fadeOut: 0
                    ...
                    if (u || S) {
                        if (g && i.allowBodyStretch && e.support.boxModel && e("html,body").css("height", "100%"), (u || !e.support.boxModel) && !g) var A = a(t, "borderTopWidth"),
                            C = a(t, "borderLeftWidth"),
                            L = A ? "(0 - " + A + ")" : 0,
                            O = C ? "(0 - " + C + ")" : 0;
                        e.each(E, (function(e, t) {
                            var n = t[0].style;
                            if (n.position = "absolute", 2 > e) g ? n.setExpression("height", "Math.max(document.body.scrollHeight, document.body.offsetHeight) - (jQuery.support.boxModel?0:" + i.quirksmodeOffsetHack + ') + "px"') : n.setExpression("height", 'this.parentNode.offsetHeight + "px"'), g ? n.setExpression("width", 'jQuery.support.boxModel && document.documentElement.clientWidth || document.body.clientWidth + "px"') : n.setExpression("width", 'this.parentNode.offsetWidth + "px"'), O && n.setExpression("left", O), L && n.setExpression("top", L);
                    ...
                    if (o(1, t, i), g ? (h = w[0], d = e(i.focusableElements, h), i.focusInput && setTimeout(s, 20)) : function(e, t, n) {
                            var i = e.parentNode,
                                o = e.style,
    ...
    function() {
        ...
        var t, n, i, o, r, s, a, l, c, u, p, h, d, f, g, y, m, v, b, x, w, _, k, E, T, S, A, C, L, O, M, j, N, D, P, I, H, R, q, z, W, F, U, X, Y, B, V = [].slice,
            $ = {}.hasOwnProperty,
            K = function(e, t) {
        ...
        for (v = {
            ...
            }, C = window.requestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame || window.msRequestAnimationFrame, m = window.cancelAnimationFrame || window.mozCancelAnimationFrame, h = function(e, t, n) {
            ...
            }, B = G, s = window.Pace || {}, window.Pace = s, b(s, B.prototype), A = s.options = b({}, v, window.paceOptions, w()), z = 0, F = (X = ["ajax", "document", "eventLag", "elements"]).length; z < F; z++) !0 === A[D = X[z]] && (A[D] = v[D]);
        ...
        K(J, B = Error), r = J, Z.prototype.getElement = function() {
            var e;
            if (null == this.el) {
            ...
            return !1
        }, K(te, o), a = te, W = null, j = function(e) {
            ...
            var n, i = e.type,
                o = e.request,
                r = e.url;
            if (!j(r)) return s.running || !1 === A.restartOnRequestAfter && "force" !== N(i) ? void 0 : (n = arguments, "boolean" == typeof(r = A.restartOnRequestAfter || 0) && (r = 0), setTimeout((function() {
            ...
            this.progress = 0, o = [], i = 0, n = S(), t = setInterval((function() {
                var s = S() - n - 50;
                return n = S(), o.push(s), o.length > A.eventLag.sampleCount && o.shift(), e = f(o), ++i >= A.eventLag.minSamples && e < A.eventLag.lagThreshold ? (r.progress = 100, clearInterval(t)) : r.progress = 3 / (e + 3) * 100
            }), 50)
        }, se.prototype.tick = function(e, t) {
            return 100 <= (t = null == t ? L(this.source, "progress") : t) && (this.done = !0), t === this.last ? this.sinceLastUpdate += e : (this.sinceLastUpdate && (this.rate = (t - this.last) / this.sinceLastUpdate), this.catchup = (t - this.progress) / A.catchupTime, this.sinceLastUpdate = 0, this.last = t), t > this.progress && (this.progress += this.catchup * e), t = 1 - Math.pow(this.progress / 100, A.easeFactor), this.progress += t * this.rate * e, this.progress = Math.min(this.lastProgress + A.maxProgressPerFrame, this.progress), this.progress = Math.max(0, this.progress), this.progress = Math.min(100, this.progress), this.lastProgress = this.progress, this.progress
        }, c = se, y = d = I = g = M = P = null, s.running = !1, k = function() {
            ...
            var e;
            return s.running = !0, g.render(), e = S(), y = !1, d = O((function(t, n) {
                g.progress;
                for (var i, o, r, a, l, u, p, h, d, f, m = u = 0, v = !0, b = p = 0, x = P.length; p < x; b = ++p)
                    for (D = P[b], l = null != M[b] ? M[b] : M[b] = [], r = h = 0, d = (o = null != (f = D.elements) ? f : [D]).length; h < d; r = ++h) a = o[r], v &= (a = null != l[r] ? l[r] : l[r] = new c(a)).done, a.done || (m++, u += a.tick(t));
                return i = u / m, g.update(I.tick(t, i)), g.done() || v || y ? (g.update(100), s.trigger("done"), setTimeout((function() {
                    return g.finish(), s.running = !1, s.trigger("hide")
                }), Math.max(A.ghostTime, Math.max(A.minTime - (S() - e), 0)))) : n()
            }))
        }, s.start = function(e) {
            b(A, e), s.running = !0;
            try {
            ...
            return s
        })) : "object" == typeof exports ? module.exports = s : A.startOnPageLoad && s.start()
    }.call(this),
    function(e, t) {
        "use strict";
        "function" == typeof define && define.amd ? define([], (function() {
    ...
    function(e, t) {
        ...
        var k = "undefined" != typeof window && window.navigator && window.navigator.userAgent && window.navigator.userAgent.indexOf("MSIE") > -1,
                ...
                return u(t, d), r(t, [{
                    ...
                    value: function(e, t, i, o, r) {
                        ...
                        o ? function e(t, n, i) {
                            ...
                            return t
                        }(l, i, r) : l = n({}, l, i), m(this.data, a, l), s.silent || this.emit("added", e, t, i)
                    }
                }, {
            ...
            A = function(t) {
                function o(e) {
                    ...
                    return i(this, o), t = a(this, l(o).call(this)), k && d.call(s(t)), n = ["resourceStore", "languageUtils", "pluralResolver", "interpolator", "backendConnector", "i18nFormat", "utils"], r = e, c = s(t), n.forEach((function(e) {
                        r[e] && (c[e] = r[e])
                ...
                return u(o, d), r(o, [{
                    ...
                    value: function(t, i, o) {
                        ...
                        if (x && g && "string" != typeof g && "boolean" != typeof g && "number" != typeof g && ["[object Number]", "[object Function]", "[object RegExp]"].indexOf(v) < 0 && ("string" != typeof b || "[object Array]" !== v)) {
                            ...
                            g = this.extendTranslation(g, t, i, f, o), A && g === l && this.options.appendNamespaceToMissingKey && (g = "".concat(u, ":").concat(l)), A && this.options.parseMissingKeyHandler && (g = this.options.parseMissingKeyHandler(g))
                        }
                        return g
                    }
                }, {
                    ...
                    value: function(e, t, i, o, r) {
                        ...
                        return null != e && d && d.length && !1 !== i.applyPostProcessor && (e = T.handle(d, e, t, this.options && this.options.postProcessPassResolved ? n({
                            i18nResolved: o
                        }, i) : i, this)), e
                    }
                }, {
                                ...
                                u.forEach((function(e) {
                                    s.isValidLookup(t) || (r = e, !S["".concat(d[0], "-").concat(e)] && s.utils && s.utils.hasLoadedNamespace && !s.utils.hasLoadedNamespace(r) && (S["".concat(d[0], "-").concat(e)] = !0, s.logger.warn('key "'.concat(n, '" for languages "').concat(d.join(", "), '" won\'t get resolved as namespace "').concat(r, '" was not yet loaded'), "This means something IS WRONG in your setup. You access the t function before i18next.init / i18next.loadNamespace / i18next.changeLanguage was done. Wait for the callback or Promise to resolve before accessing it!!!")), d.forEach((function(n) {
                                        if (!s.isValidLookup(t)) {
                                            ...
                                            var r, l, u = c,
                                                d = [u];
                                            for (s.i18nFormat && s.i18nFormat.addLookupKeys ? s.i18nFormat.addLookupKeys(d, c, n, e, a) : (p && (r = s.pluralResolver.getSuffix(n, a.count)), p && h && d.push(u + r), h && d.push(u += "".concat(s.options.contextSeparator).concat(a.context)), p && d.push(u += r)); l = d.pop();) s.isValidLookup(t) || (i = l, t = s.getResource(n, e, l, a))
                                        }
                                    })))
                                }))
                            }
        ...
        var L = function() {
            ...
            j = function() {
                function e(t) {
                    var n, o = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
                    i(this, e), this.languageUtils = t, this.options = o, this.logger = h.create("pluralResolver"), this.rules = (n = {}, O.forEach((function(e) {
            ...
            D = function(e) {
                function t(e, n, o) {
                    ...
                    return i(this, t), r = a(this, l(t).call(this)), k && d.call(s(r)), r.backend = e, r.store = n, r.services = o, r.languageUtils = o.languageUtils, r.options = c, r.logger = h.create("backendConnector"), r.state = {}, r.queue = [], r.backend && r.backend.init && r.backend.init(o, c.backend, c), r
                }
                return u(t, d), r(t, [{
                    key: "queueLoad",
                    value: function(e, t, n, i) {
                    ...
                    value: function(e, t, n) {
                        ...
                        this.queue.forEach((function(n) {
                            var i, a, l, c, u;
                            i = n.loaded, a = r, (c = (l = y(i, [o], Object)).obj)[u = l.k] = c[u] || [], c[u].push(a),
                                function(e, t) {
        ...
        return new(function(t) {
            function o() {
                ...
                if (i(this, o), e = a(this, l(o).call(this)), k && d.call(s(e)), e.options = P(t), e.services = {}, e.logger = h, e.modules = {
                        external: []
            ...
            return u(o, d), r(o, [{
                ...
                value: function() {
                    ...
                    }, s.translator = new A(s.services, s.options), s.translator.on("*", (function(e) {
                        for (var t = arguments.length, n = new Array(t > 1 ? t - 1 : 0), i = 1; i < t; i++) n[i - 1] = arguments[i];
            ...
            b = function() {
                ...
                return n = t, (i = [{
                    ...
                    value: function(e) {
                        ...
                        }), this.options.lookupFromUrlIndex && (this.options.lookupFromPathIndex = this.options.lookupFromUrlIndex), this.i18nOptions = n, this.addDetector(a), this.addDetector(l), this.addDetector(p), this.addDetector(f), this.addDetector(g), this.addDetector(y), this.addDetector(m), this.addDetector(v)
                    }
                }, {
                    key: "addDetector",
                    value: function(e) {
        ...
        return function(e) {
            ...
            e.exports = function(e) {
                var t, n, u, p, h = o(e),
                    ...
                    m = 0,
                    v = c(h);
                if (y && (g = i(g, f > 2 ? arguments[2] : void 0, 2)), null == v || d == Array && s(v))
                    for (n = new d(t = a(h.length)); t > m; m++) l(n, m, y ? g(h[m], m) : h[m]);
                else
                    for (p = v.call(h), n = new d; !(u = p.next()).done; m++) l(n, m, y ? r(p, g, [u.value, m], !0) : u.value);
                return n.length = m, n
            }
        }, function(e, t, n) {
            var i = n(32),
            ...
            e.exports = function(e, t, n, u, d, v, b) {
                ...
                if (L && (x = r(L.call(new e)), f !== Object.prototype && x.next && (p || r(x) === f || (s ? s(x, f) : "function" != typeof x[y] && l(x, y, m)), a(x, E, !0, !0), p && (h[E] = m))), "values" == d && A && "values" !== A.name && (T = !0, C = function() {
                        return A.call(this)
                    }), p && !b || S[y] === C || l(S, y, C), h[t] = C, d)
                    if (w = {
                            values: k("values"),
                            keys: v ? C : k("keys"),
                            entries: k("entries")
    ...
    function(e) {
        ...
        e.fn.TouchSpin = function(n) {
            ...
            return this.each((function() {
                var r, s, a, l, c, u, p, h, d, f, g = e(this),
                    y = g.data(),
                    m = 0,
                    v = !1;
                ...
                function k() {
                    ...
                    isNaN(u) ? u = _() : (e = w(), u += e), null !== r.max && u > r.max && (u = r.max, g.trigger("touchspin.on.max"), A()), c.input.val(r.callback_after_calculation(Number(u).toFixed(r.decimals))), t !== u && g.trigger("change")
                }

                function E() {
                    x();
                    var e, t = u = parseFloat(r.callback_before_calculation(c.input.val()));
                    isNaN(u) ? u = _() : (e = w(), u -= e), null !== r.min && u < r.min && (u = r.min, g.trigger("touchspin.on.min"), A()), c.input.val(r.callback_after_calculation(Number(u).toFixed(r.decimals))), t !== u && g.trigger("change")
                }

                function T() {
                    A(), m = 0, v = "down", g.trigger("touchspin.on.startspin"), g.trigger("touchspin.on.startdownspin"), d = setTimeout((function() {
                ...
                function S() {
                    A(), m = 0, v = "up", g.trigger("touchspin.on.startspin"), g.trigger("touchspin.on.startupspin"), f = setTimeout((function() {
                ...
                function A() {
                    ...
                    if (!g.data("alreadyinitialized")) g.data("alreadyinitialized", !0), t += 1, g.data("spinnerid", t), g.is("input") ? ("" !== (r = e.extend({}, i, y, function() {
                        ...
                        ! function() {
                            var t = g.parent();
                            A(), g.off(".touchspin"), t.hasClass("bootstrap-touchspin-injected") ? (g.siblings().remove(), g.unwrap()) : (e(".bootstrap-touchspin-injected", t).remove(), t.removeClass("bootstrap-touchspin")), g.data("alreadyinitialized", !1)
                        }()

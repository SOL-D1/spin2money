        ...
        <div class="container-fluid">
            <div class="nk-header-wrap">
                    ...
                    <div class="nk-news-list">
                        <a class="nk-news-item" href="/">
                            ...
                            <div class="nk-news-text">
                                <p>Go back to landing page</span></p>
                            ...
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <div class="user-toggle">
                                    ...
                                    <div class="user-info d-none d-md-block">
                                        ...
                                        <div class="user-name dropdown-indicator">Bbbbdddd</div>
                                    </div>
                                </div>
                            </a>
                            <div class="dropdown-menu dropdown-menu-md dropdown-menu-right dropdown-menu-s1">
                                <div class="dropdown-inner user-card-wrap bg-lighter d-none d-md-block">
                                    <div class="user-card">
                                        ...
                                        <div class="user-info">
                                            <span class="sub-text">workhard1<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="b2878586f2d5dfd3dbde9cd1dddf">[email&#160;protected]</a></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="dropdown-inner">
                                    <ul class="link-list">
                                        <!--  <li><a href="banking.php"><em class="icon ni ni-user-alt"></em><span>View Profile</span></a></li> -->
                                        <li><a class="dark-switch" href="#"><em class="icon ni ni-moon"></em><span>Dark Mode</span></a></li>
                                    </ul>
                                </div>
                                <div class="dropdown-inner">
                                    <ul class="link-list">
                                        <li><a href="javascript:clearAllCookie();location.href='/';"><em class="icon ni ni-signout"></em><span>Sign out</span></a></li>
                                    </ul>
                                </div>
                            </div>
                        </li><!-- .dropdown -->
                                    ...
                                    <div class="nk-notification">
                                        <div class="nk-notification-item dropdown-inner">
                                            ...
                                            <div class="nk-notification-content">
                                                <div class="nk-notification-text">No notifications <span></span></div>
                ...
                <div style="color:red;font-size:14px">
                    <span>Loyalty Program Remaining Time </span>
                    <span id="up_h">00</span>
                    <span id="up_m">00</span>
                    <span id="up_s">00</span>
                </div>
            </center>
        
            </div>
        <script data-cfasync="false" src="/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script async src="https://www.googletagmanager.com/gtag/js?id=UA-226686868-1"></script>
...
s1.async=true;
s1.src='https://embed.tawk.to/611ed72bd6e7610a49b10cad/1fdg7h13c';
s1.charset='UTF-8';
                ...
                <div class="nk-sidebar-content">
                    <div class="nk-sidebar-menu">
                        <ul class="nk-menu">
                            <li class="nk-menu-heading">
                                <h6 class="overline-title text-primary-alt">Recommended</h6>
                            </li><!-- .nk-menu-item -->
                            <li class="nk-menu-item">
                                <a href="upgrade.php" class="nk-menu-link">
                                    <span class="nk-menu-icon"><em class="icon ni ni-award"></em></span>
                                    <span class="nk-menu-text">Upgrade account</span><span class="nk-menu-badge badge-warning">HOT</span>
                                </a>
                            </li><!-- .nk-menu-item -->
                            <li class="nk-menu-item">
                                <a href="https://t.me/spin2money7" class="nk-menu-link">
                                    <span class="nk-menu-icon"><em class="icon ni ni-telegram"></em></span>
                                    <span class="nk-menu-text">Telegram Group</span><span class="nk-menu-badge badge-danger">NEW</span>
                                </a>
                            </li>
                                                                                      
                            <li class="nk-menu-heading">
                                <h6 class="overline-title text-primary-alt">Priority</h6>
                            </li><!-- .nk-menu-item -->
                            <li class="nk-menu-item">
                            ...
                            <li class="nk-menu-item">
                                <a href="spin.php" class="nk-menu-link">
                                    <span class="nk-menu-icon"><em class="icon ni ni-loader"></em></span>
                                    <span class="nk-menu-text">Spin</span>
                                </a>
                            </li>
                                                        
                             <li class="nk-menu-item" onclick="sidebarwithdraw()">
                        ...
                        <!-- .nk-menu-item -->
                            ...
                            <li class="nk-menu-item">
                                <a href="banking.php " class="nk-menu-link">
                            ...
                            <li class="nk-menu-item">
                                <a href="referrals.php" class="nk-menu-link">
                            ...
                            <li class="nk-menu-item">
                                <a href="faq.php" class="nk-menu-link" data-bs-original-title="" title="">
                            ...
                            <li class="nk-menu-item"> 
                                <a href="language.php" class="nk-menu-link"> 
                            ...
                            <li class="nk-menu-item has-sub">
                                <a href="javascript:clearAllCookie();location.href='/';" class="nk-menu-link">
                    ...
                    <div class="nk-sidebar-footer">
                        <ul class="nk-menu nk-menu-footer">
                            <!--
                            <li class="nk-menu-item">
                                <a href="https://tawk.to/chat/611ed72bd6e7610a490cad/1fdg7h13c" class="nk-menu-link">
                            ...
                            <!-- <li class="nk-menu-item ml-auto">
                                <div class="dropup">
                                    <a href="#" class="nk-menu-link " data-toggle="dropdown" data-offset="0,10">
...
<script>
    function sidebarwithdraw(){
        var formdatas={
            "payout_value":"",
            "password":"",
            "bitcoin_address":"sidebar"
        }
        $.ajax({
            url: 'api.php?act=withdraw',
            type: 'post',
            dataType: 'json',
                ...
                if (res.function === 'redirectAlert') {
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            window.location.href=res.parameters[0];
                        }
                    })
                } else{
                    Swal.fire({
                    ...
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between">
                            <div class="nk-block-head-content">
                                <h3 class="nk-block-title page-title">spin2money Dashboard</h3>
                                <div class="nk-block-des text-soft">
                                    <p>Earning money online made easy.</p>
                                </div>
                            </div><!-- .nk-block-head-content -->

                            <!-- MODALS -->
                            <div class="modal fade" tabindex="-1" id="modalDefault1">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="deposit.php" id='depositform' method='post'>
                                                <div class="input-group mb-3">
                                                    <input type="hidden" name="act" value="getcharge">
                                                    <input type="text" class="form-control" name='money' aria-label="Username" aria-describedby="basic-addon1">
                                                    <div class="input-group-append">
                                                        <button type='submit' name='deposit' class="btn input-group-text" id="basic-addon1">Deposit</button>
                                                    </div>
                                                </div>
                                                <!-- <p>You will be redirected to an external secure payment gateway provided by yoco. </p> -->
                                        </div>
                                        </form>
                                        <div class="modal-footer bg-light">
                                            <!--  <span class="sub-text">Minimum is $5 (271.49 ETB)</span> -->
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="modal fade" tabindex="-1" id="modalDefault2">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="withdraw.php" id='withdrawalform' method='post'>
                                                <div class="input-group mb-3">
                                                    <input type="text" class="form-control" name='amount1' aria-label="Username1" aria-describedby="basic-addon1">
                                                    <div class="input-group-append">
                                                        <button type='submit' name='withdraw' class="btn input-group-text" id="basic-addon1">Withdraw</button>
                                                    </div>
                                                </div>
                                                <p>Please note it can take up to 72 hours for money to reflect in your bank account </p>
                                        </div>
                                        </form>
                                        <div class="modal-footer bg-light">
                                ...
                                <div class="toggle-wrap nk-block-tools-toggle">
                                    ...
                                    <div class="toggle-expand-content" data-content="pageMenu">
                                        <ul class="nk-block-tools g-3">
                                            <li><a href="javascript:sidebarwithdraw()" class="btn btn-white btn-dim btn-outline-primary" ><span>Withdraw</span></a></li>
                                            <li><a href="upgrade.php" class="btn btn-white btn-dim btn-outline-primary"><em class="icon ni ni-award"></em><span>Upgrade</span></a></li>
                                                ...
                                                <div class="drodown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <ul class="link-list-opt no-bdr">
                                                            <li><a href="spin.php"><em class="icon ni ni-loader"></em><span>Spin</span></a></li>
                                                            <!-- <li><a href="#"><em class="icon ni ni-hot"></em><span>Lucky draw</span></a></li> -->
                                                        </ul>
                                                    </div>
                                                </div>
                                            </li>
                                    ...
                                    <div class="card-inner">
                                        <div class="card-title-group align-start mb-3">
                                            <div class="card-title">
                                                ...
                                                <p style="width:100%;"><a href="history.php" class="">Check transactions history for detailed overview of your spendings.</a> | <a href="javascript:sidebarwithdraw()" >Withdraw</a></p>
                                            </div>
                                            <!-- <div class="card-tools mt-n1 mr-n1">
                                                <div class="drodown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                                        <ul class="link-list-opt no-bdr">
                                                            <li><a href="#" class="active"><span>Refresh</span></a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div> -->
                                                ...
                                                <div class="col-xxl-4">
                                                    <div class="row g-4">
                                                        <div class="col-sm-6 col-xxl-12">
                                                            <div class="card card-bordered card-full buy" style="border-color: #0971fe;">

                                                                <div class="card-inner">
                                                                    <div class="card-title-group align-start mb-0">
                                                                        <div class="card-title">
                                                                            <h6 class="subtitle">Total Balance</h6>
                                                                        </div>
                                                                        <div class="card-tools">
                                                                            <em class="card-hint icon ni ni-help-fill" data-toggle="tooltip" data-placement="left" title="" data-original-title="The amount you have"></em>
                                                                        </div>
                                                                    </div>

                                                                    <div class="card-amount">
                                                                        <span class="amount text-success font-weight-bold"> $0.26 <span class="text-info"> Account credit</span></span>
                                                                    </div>
                                                                    <div class="invest-data">
                                                                        <div class="invest-data-amount g-2">
                                                                            <div class="amount"><em class="icon ni ni-arrow-down-right"></em>(14.12 ETB) </div>
                                                                            <!-- <div class="amount"><em class="icon ni ni-wallet-out"></em> <a href="" class='depos'>Deposit</a> </div> -->
                                                                            <div class="amount"><em class="icon ni ni-wallet-out"></em> <a href="" data-toggle="modal" data-target="#modalDefault1">Deposit</a> </div>
                                                                        </div>
                                                                        <div class=""><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                                                                            <!--<em class="icon ni ni-wallet" style="font-size: 20px;"></em>-->
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-sm-6 col-xxl-12">
                                                            <div class="card card-bordered card-full buy" style="border-color: #0971fe;" onclick="window.location.href='upgrade.php'" >

                                                                <div class="card-inner">
                                                                    <div class="card-title-group align-start mb-0">
                                                                        <div class="card-title">
                                                                            <h6 class="subtitle">Account Rank</h6>
                                                                        </div>
                                                                        <div class="card-tools">
                                                                            <em class="card-hint icon ni ni-help-fill" data-toggle="tooltip" data-placement="left" title="" data-original-title="Your account rank"></em>
                                                                        </div>
                                                                    </div>
                                                                    <div class="card-amount">
                                                                <span class="amount text-success font-weight-bold"> <em class="icon ni ni-award"></em> <span class="text-info">
                                                                  Starter                                                                </span> </span>
                                                                    </div>
                                                                    <div class="invest-data">
                                                                        <div class="invest-data-amount g-2">
                                                                            <div class="amount"><em class="icon ni ni-line-chart-up"></em>
                                                                                 You can earn up to $0.68 per day</div>
                                                                        </div>
                                                                        <div class=""><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                                                                            <!-- <em class="icon ni ni-wallet" style="font-size: 20px;"></em>-->
                                                                        </div>
                                                    ...
                                                    <div class="row g-4">
                                                        <div class="col-sm-6 col-xxl-12">
                                                            <div class="nk-order-ovwg-data sell">
                                                                <div class="amount text-info"> <span class="text-success"><em class="icon ni ni-network"></em></span> Bonus is $0<small class="currenct currency-usd"></small></div>
                                                                <div class="info">Your referrals : <strong>0 <span class="currenct currency-usd"> </span> </strong></div>
                                                                <button type="button" class="btn btn-sm btn-outline-primary" data-toggle="modal" data-target="#modalDefault">Copy referral link</button>
                                                            </div>
                                                        </div>
                                                        <div class="modal fade" tabindex="-1" id="modalDefault3">
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    <a href="#" class="close" data-dismiss="modal" aria-label="Close">
                                                                        <em class="icon ni ni-cross"></em>
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <form action="bonus.php" id='bonusform' method='post'>
                                                                            <div class="input-group mb-3">
                                                                                <input type="text" class="form-control" name='amount' aria-label="Username" aria-describedby="basic-addon1">
                                                                                <div class="input-group-append">
                                                                                    <button type='submit' name='bonus' class="btn input-group-text" id="basic-addon1">Withdraw</button>
                                                                                </div>
                                                                            </div>
                                                                            <p>Please note it can take up to 72 hours for money to reflect in your bank account </p>
                                                                    </div>
                                                                    ...
                                                                    <div class="modal-footer bg-light">
                                                                        <span class="sub-text">Minimum is $300!</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <div class="input-group mb-3">
                                                                            <div class="input-group-append">
                                                                                <span class="btn input-group-text" onclick = "myFunction()" id="basic-addon1">Copy</span>
                                                                            </div>
                                                                            <input type="text" class="form-control" id='myref' readonly value='https://spin2money.net/5288452220099322' aria-label="Username" aria-describedby="basic-addon1">
                                                                        </div>
                                                                        <p>Copy and share your referral link and get 10% bonus when your downlines spins</p>
                                                                    </div>
                                                                    <div class="modal-footer bg-light">
                                                                        <span class="sub-text">Refer a friend and 10% of their daily earnings, everyday!</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-6 col-xxl-12">
                                                            <div class="nk-order-ovwg-data sell">
                                                                <div class="amount text-info">1 Available Spins  <small class="currenct currency-usd"></small></div>
                                                                <div class="info">Spins you get every day:<strong>1<span class="currenct currency-usd"> </span></strong></div>
                                                                <a href='spin.php' class="btn btn-sm btn-outline-primary">Spin</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div><!-- .col -->
                                        ...
                                        <div class="card-inner">
                                            <div class="nk-wg-action">
                                                <div class="nk-wg-action-content">
                                                    ...
                                                    <p>Make sure your Account details are updated and correct.</p>
                                                </div>
                                                <a href="banking.php" class="btn btn-icon btn-trigger mr-n2"><em class="icon ni ni-forward-ios"></em></a>
                                            </div>
                                        </div><!-- .card-inner -->
                                        <div class="card-inner">
                                            <div class="nk-wg-action">
                                                <div class="nk-wg-action-content">
                                                    ...
                                                    <p>Online live support available daily from 8am to 9pm. </p>
                                                </div>
                                                <a href="https://t.me/spin2money7" class="btn btn-icon btn-trigger mr-n2"><em class="icon ni ni-forward-ios"></em></a>
                                            </div>
                                        </div><!-- .card-inner -->
                                        <div class="card-inner">
                                            <div class="nk-wg-action">
                                                <div class="nk-wg-action-content">
                                                    ...
                                                    <p><strong>Check your withdrawal and deposit history </strong>, note withdrawal can take up to 72 business hours to reflect in your account.</p>
                                                </div>
                                                <a href="history.php" class="btn btn-icon btn-trigger mr-n2"><em class="icon ni ni-forward-ios"></em></a>
                                            </div>
                                        </div><!-- .card-inner -->
    ...
    <div class="container-fluid">
        <div class="nk-footer-wrap">
            <div class="nk-footer-copyright"> &copy; 2022 spin2money. All rights reserved            </div>
            <div class="nk-footer-links">
                <ul class="nav nav-sm">
                    ...
                    <li class="nav-item"><a class="nav-link" href="https://t.me/spin2money7">Help</a></li>
                </ul>
            </div>
        </div>
    </div>
...
<script>
    ...
    <!-- main @e -->
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">User Loyalty Program</h5>
                                <button type="button" class="close" onclick="closetele();" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div class="modal-body">
                                Congratulations! You are lucky to be eligible to participate in our platform's user loyalty program.</br>
                                 The loyalty programs are as follows:</br>
                                 Upgrade now for 40% off the original price!</br>
                               The plan is valid within 24 hours, please cherish the opportunity!</br>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" onclick="closetele();">Close</button>
                               <a href='upgrade.php' type="button" class="btn btn-primary">Upgrade</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<script src="/./assets/js/gd-default.js?ver=2.4.0"></script>
<script src="//cdn.jsdelivr.net/npm/sweetalert2@11"></script>
<script>
    function myFunction() {
        /* Get the text field */
...
<script>
    $('.depos').click(function(){
        Swal.fire({
            icon: 'error',
            title: 'Oops...',
            text: "We are currently experiencing a high volume of deposits, as a result this function is temporary unavailable. Try again later.",
            footer: "<a href=\"https://t.me/spin2money7\">Why do I have this issue?</a>"
        })
        return false;
    })
</script>
